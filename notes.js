...
window.providerNotes = {
  ...
  "Maileroo": "SMTP relay with clean API, inbound support, logs, and fast support.",
  ...
  "Loops": "US-based, SaaS-focused; marketing + transactional; Y Combinator; no daily limit."
};
